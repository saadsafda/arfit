...
export class UpdateUserFaceImageUseCase {
  ...
  async execute(userIdentifier, faceImage, userType) {
    ...
    repoReturnedValues = await this.userFaceImageRepository.updateUserFaceImage(
      userFaceImage
    );
    ...
    return new APIResponse(
      new APIResponseMessage(
        APIResponseConstants.USER_FACE_IMAGE_UPDATED_MESSAGE,
        APIResponseConstants.USER_FACE_IMAGE_UPDATED_MESSAGE_CODE
      ),
